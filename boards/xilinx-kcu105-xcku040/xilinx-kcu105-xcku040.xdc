...
set_property PACKAGE_PIN AM17 [get_ports {spi_sck}]
set_property PACKAGE_PIN AL14 [get_ports {spi_miso}]
set_property PACKAGE_PIN AM14 [get_ports {spi_mosi}]

set_property PACKAGE_PIN AP16 [get_ports {spi_1_sck}]
set_property PACKAGE_PIN AP15 [get_ports {spi_1_miso}]
set_property PACKAGE_PIN AM16 [get_ports {spi_1_mosi}]
set_property PACKAGE_PIN AM15 [get_ports {spi_2_sck}]
set_property PACKAGE_PIN AN18 [get_ports {spi_2_miso}]
set_property PACKAGE_PIN AN17 [get_ports {spi_2_mosi}]

set_property UNAVAILABLE_DURING_CALIBRATION true [get_ports {spi_miso}]
